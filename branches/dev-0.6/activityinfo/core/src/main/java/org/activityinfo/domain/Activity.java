...
/**
 * After the {@link org.activityinfo.domain.UserDatabase}, the activity is the second level of organization in ActivityInfo.
 * Each activity has its set of indicators and attributes.
 *
 * Realized activities takes place at {@link org.activityinfo.domain.Site} sites.
 *
 *
 * @author Alex Bertram
 */
