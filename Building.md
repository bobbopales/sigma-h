...
**Warning:** If your want to rebuilt the app with a new war, shutdown your tomcat server, delete the old war AND the old app folder, and only then you can paste the new war and start the server.
